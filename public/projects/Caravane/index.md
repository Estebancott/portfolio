...
> Il est muni d'une applique incorporée (ampoule à vis de 12 V
...
J’ai donc simplement raccordé une **batterie de tracteur** à la place de la sortie du transformateur, pour alimenter tout le circuit en 12 V.  
Et cerise sur le gâteau : si une voiture se branche via la prise de remorque, l’alimentation peut toujours venir d’elle comme prévu à l’origine.  

---

## Ajout du système audio et modernisation
Côté son, j’ai récupéré **6 haut-parleurs** et un **autoradio** provenant d’une voiture destinée à la casse.  
L’avantage est évident : ils fonctionnent tous en **12 V**, donc parfaitement adaptés au circuit de la caravane.  

Pour améliorer la qualité audio, j’ai ajouté :
- un **filtre passe-bas** pour les basses,
- un **filtre passe-haut** pour les aigus,
- tout en gardant deux haut-parleurs pour les médiums.

Ainsi, on profite d’un son équilibré avec basses, aigus et médiums bien répartis.  

J’ai également intégré un petit module type “allume-cigare de voiture” permettant :  
- l’affichage en temps réel de la **tension de la batterie**,  
- une **prise USB-A et USB-C** pour recharger les téléphones,  
- deux câbles USB-C intégrés, très pratiques pour les invités.  

Enfin, un **panneau solaire** (avec contrôleur acheté sur AliExpress) permet de recharger la batterie en continu, rendant la caravane totalement **autonome**.  
